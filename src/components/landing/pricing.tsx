...
const plans = [
  {
    ...
    features: ['5 landing page templates', 'Basic customization options', 'Export to HTML/CSS', '48-hour email support'],
    popular: false,
  },
  {
    name: 'Pro',
    ...
    <div id="pricing" className="py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl sm:text-center">
          ...
          <p className="mt-2 text-4xl font-bold tracking-tight text-primary sm:text-5xl">Choose the perfect plan for your needs</p>
        </div>
        <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-muted-foreground sm:text-center">
          Offers flexible pricing options to suit developers and teams of all sizes. Start building stunning landing pages
          faster than ever.
        </p>
        <div className="mt-20 flow-root">
          <div className="isolate -mt-16 grid max-w-sm grid-cols-1 gap-x-4 gap-y-16 sm:mx-auto lg:-mx-8 lg:mt-0 lg:max-w-none lg:grid-cols-3 xl:-mx-4">
            {plans.map(plan => (
