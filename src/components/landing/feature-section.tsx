  ...
  return (
    <div id="features" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto mb-16 max-w-2xl text-center">
        <h2 className="text-base font-semibold leading-7 text-primary">Next Start</h2>
        ...
        <p className="mt-6 text-lg leading-8 text-muted-foreground">
          Next Start is a powerful landing page builder for developers, offering code templates and components inspired by shadcn. Create
